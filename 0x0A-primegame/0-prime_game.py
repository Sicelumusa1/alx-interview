...
def isWinner(x, nums):
    """
    Determine the winner of a series of games where Maria and Ben take
    turns removing prime numbers from a set

    Args:
        x (int): The number of rounds to play
        nums (list): A list of integers representing the upper bounds of
        the sets for each round
